...
class simple_uav():
    ...
    def setTargetPos(self,x,y,z):
        ...
        # self.targetPos.pose.orientation.x = 0
        # self.targetPos.pose.orientation.y = 0
        # self.targetPos.pose.orientation.z = 0
        # self.targetPos.pose.orientation.w = 1

    def sendTargetPos(self):
        rate = rospy.Rate(20.0)
        while not rospy.is_shutdown() and not self.stopThread:
            if self.targetPos is not None:
                self.targetPos.header.stamp = rospy.Time.now()
